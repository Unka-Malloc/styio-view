...
| `AGENT-RUNTIME-RUNBOOK.md` | [Agent Runtime Runbook](./AGENT-RUNTIME-RUNBOOK.md) | Define the Coding Agent runtime owner's responsibilities, owned paths, review checklist, and required gates. Enforce credential safety, permission audit, patch workflow, and journal/audit compliance. |
