    ...
    return const IdeCapabilityFrameworkSnapshot(
      ...
      entries: <IdeCapabilityDescriptor>[
        ...
        IdeCapabilityDescriptor(
          ...
          summary:
              'Testing surface is wired to runTests, native tool testResult records, TestRunProvider registry, TestDiscoveryProvider registry, test run configurations, test tree model, run history, runtime task lifecycle snapshots, persisted runtime task history, failed-test rerun planning, failed-test interaction, rerun-failed handoff, and CTest result parsing.',
          todo:
        ...
        IdeCapabilityDescriptor(
          ...
          summary:
              'Terminal surface is wired to shell/runtime output, run handoff, PTY session snapshots, TerminalInteractionController input/resize/close contracts, and shared runtime task lifecycle snapshots on start/close.',
          todo:
        ...
        IdeCapabilityDescriptor(
          ...
          summary:
              'DAP launch contracts, breakpoint serialization, launch profiles, workspace launch configuration sets, Foundation DataStore persistence, and runtime task projection are wired.',
          todo:
              'TODO: wire non-C++ debug adapters, launch UI editing, DAP event task history, and test debug handoff.',
        ...
        IdeCapabilityDescriptor(
          ...
          summary:
              'Module manifests can be projected into stable extension manifests with activation events, contribution points, capability flags, registry lookup, Foundation DataStore persistence, and contribution route manifests for target registries.',
          todo:
              'TODO: let command/language/debug/toolchain registries consume extension route manifests and add extension host activation.',
          references: <String>[
        ...
        IdeCapabilityDescriptor(
          ...
          summary:
              'Runtime Surface exposes Output Channels for runtime events, stdout, stderr, native tool activity, serializable output channel filters, and reusable output channel snapshots.',
          todo:
              'TODO: add user-selectable channel controls, agent activity, language-service logs, debug events, and persisted output history.',
          references: <String>[
