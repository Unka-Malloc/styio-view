...
AppCommandDescriptor? _appCommandDescriptorForName(String commandId) {
  return VityoCommandRegistry.descriptorForName(commandId);
}
...
class AgentCommandCatalogContext {
  ...
  factory AgentCommandCatalogContext.fromRegistry({
    ...
    final nativeToolCommands = VityoCommandRegistry.nativeToolCommands
        .map(AgentCommandContext.fromDescriptor)
        .toList(growable: false);
    final debugCommands = VityoCommandRegistry.debugCommands
        .map(AgentCommandContext.fromDescriptor)
        .toList(growable: false);
    ...
    return AgentCommandCatalogContext(
      persistenceCommands: VityoCommandRegistry.persistenceCommands
          .map(AgentCommandContext.fromDescriptor)
          .toList(growable: false),
      executionCommands: VityoCommandRegistry.executionCommands
          .map(AgentCommandContext.fromDescriptor)
          .toList(growable: false),
      diagnosticCommands: VityoCommandRegistry.diagnosticCommands
          .map(AgentCommandContext.fromDescriptor)
          .toList(growable: false),
      languageServiceCommands: VityoCommandRegistry.languageServiceCommands
          .map(AgentCommandContext.fromDescriptor)
          .toList(growable: false),
      sourceControlCommands: VityoCommandRegistry.sourceControlCommands
          .map(AgentCommandContext.fromDescriptor)
          .toList(growable: false),
      workspaceFileCommands: VityoCommandRegistry.workspaceFileCommands
          .map(AgentCommandContext.fromDescriptor)
          .toList(growable: false),
      codingCommands: VityoCommandRegistry.agentCodingCommands
          .map(AgentCommandContext.fromDescriptor)
          .toList(growable: false),
      navigationCommands: VityoCommandRegistry.navigationCommands
          .map(AgentCommandContext.fromDescriptor)
          .toList(growable: false),
      refactorCommands: VityoCommandRegistry.refactorCommands
          .map(AgentCommandContext.fromDescriptor)
          .toList(growable: false),
      dependencyCommands: VityoCommandRegistry.dependencyCommands
          .map(AgentCommandContext.fromDescriptor)
          .toList(growable: false),
      toolchainCommands: VityoCommandRegistry.toolchainCommands
          .map(AgentCommandContext.fromDescriptor)
          .toList(growable: false),
      deploymentCommands: VityoCommandRegistry.deploymentCommands
          .map(AgentCommandContext.fromDescriptor)
          .toList(growable: false),
      moduleCommands: VityoCommandRegistry.moduleCommands
          .map(AgentCommandContext.fromDescriptor)
          .toList(growable: false),
      surfaceCommands: VityoCommandRegistry.surfaceCommands
          .map(AgentCommandContext.fromDescriptor)
          .toList(growable: false),
      ...
      testingCommands: VityoCommandRegistry.testingCommands
          .map(AgentCommandContext.fromDescriptor)
          .toList(growable: false),
      ...
      settingsCommands: VityoCommandRegistry.settingsCommands
          .map(AgentCommandContext.fromDescriptor)
          .toList(growable: false),
