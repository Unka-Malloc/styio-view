...
18. Prototype editor selftest launcher changes must preserve `PYTHON_BIN`, `VITYO_CHROME_PATH` / `CHROME_EXECUTABLE`, and `VITYO_EDITOR_URL` behavior across Linux, Windows, and macOS CI hosts.
