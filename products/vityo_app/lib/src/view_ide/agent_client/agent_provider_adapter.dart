...
Map<String, Object?> _vityoStructuredContentPartsSchema() {
  final registeredCommandIds = VityoCommandRegistry.commands
            ...
            'command': <String, Object?>{
              ...
              'properties': <String, Object?>{
                'commandId': <String, Object?>{
                  ...
                  'description':
                      'Registered Vityo command id from the IDE command catalog.',
                },
                'input': <String, Object?>{
                  'type': 'string',
                  'description':
...
- If Vityo context includes document.textStart greater than 0, add document.textStart to offsets derived from document.text.
...
- Treat compiler identity as a Styio-owned machine fact. Use registered generic toolchain selection commands only when the reported local catalog offers a compatible candidate.
