    ...
    return const IdeCapabilityFrameworkSnapshot(
      ...
      entries: <IdeCapabilityDescriptor>[
        ...
        IdeCapabilityDescriptor(
          ...
          summary:
              'Testing surface is wired to runTests, native tool testResult records, TestRunProvider registry, TestDiscoveryProvider registry, test run configurations, persisted run configuration sets, run/debug selected configuration controls, test tree model, persisted test run history, runtime task lifecycle snapshots, persisted runtime task history, output stream subscription plans, failed-test rerun planning, failed-test interaction, rerun-failed handoff, debug launch route plans, failure navigation actions, and CTest result parsing.',
          todo:
        ...
        IdeCapabilityDescriptor(
          ...
          summary:
              'Terminal surface is wired to shell/runtime output, RuntimeOutputLiveBuffer panel snapshots, run handoff, PTY session snapshots, explicit start/resize/close UI controls, TerminalInteractionController input/resize/close contracts, serializable interaction events, terminal-to-runtime-output event conversion, ShellCommandResult output binding, shared runtime task lifecycle snapshots on start/close, and persisted terminal task history.',
          todo:
              'TODO: connect concrete ShellManager process execution and OS PTY streams to the terminal output bindings.',
          references: <String>[
        ...
        IdeCapabilityDescriptor(
          ...
          ownerPath: 'lib/src/view_ide/module_host',
          summary:
              'Extensions surface is wired to visible and mounted module manifests, lifecycle state, enable/disable/trust actions, update flags, refreshModules handoff, rendered marketplace index search results, install-plan controls, install execution steps, signature verification policy gates, lifecycle policy decisions, host-isolation planning, and Foundation DataStore-backed marketplace cache.',
          todo:
              'TODO: replace planned downloads/signature checks with concrete package IO, add update download execution, and persist lifecycle policy choices.',
          references: <String>[
