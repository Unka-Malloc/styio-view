...
import 'package:vityo_app/src/ide/workspace/hosted_workspace_lifecycle.dart';
import 'package:vityo_app/src/ide/workspace/workspace_diagnostics.dart';
...
void main() {
  ...
  group('command palette workflow', () {
    final allCommands = VityoCommandRegistry.commands.toList(growable: false);
