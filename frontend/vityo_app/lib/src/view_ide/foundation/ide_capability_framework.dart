    ...
    return const IdeCapabilityFrameworkSnapshot(
      ...
      entries: <IdeCapabilityDescriptor>[
        ...
        IdeCapabilityDescriptor(
          ...
          summary:
              'Workspace text search service, file quick open service, replace preview contract, agent search command, user search surface, and match-level navigation callback are wired.',
          todo:
              'TODO: add indexed workspace search, symbol search, replace apply confirmation, and richer diff UI.',
          references: <String>[
        ...
        IdeCapabilityDescriptor(
          ...
          summary:
              'Testing surface is wired to runTests, native tool testResult records, TestRunProvider registry, TestDiscoveryProvider registry, test tree model, run history, failed-test interaction, rerun-failed handoff, and CTest result parsing.',
          todo:
              'TODO: connect run configuration, per-test rerun, debug-test launch, and richer failure navigation contracts.',
