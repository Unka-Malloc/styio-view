...
class AgentCodingSkillCatalog {
  ...
  static const List<AgentCodingSkill> defaultSkills = <AgentCodingSkill>[
    ...
    AgentCodingSkill(
      skillId: 'vityo-agent-command-loop',
      title: 'Vityo Agent Command Loop',
      appliesTo: <String>[
        'Styio',
        'agent coding',
        'language commands',
    ...
    AgentCodingSkill(
      skillId: 'vityo-feature-loop',
      title: 'Vityo Feature Loop',
      appliesTo: <String>[
        'Styio',
        'completion',
        'hover',
  ...
  static AgentSkillContext contextForWorkspace({
    ...
    if (hasStyio || styioServiceAvailable) {
      ...
      activate('vityo-feature-loop', <String>[
        hasStyio
            ? 'Vityo features should adapt completion, hover, diagnostics, semantic tokens, definition, references, and rename from language facts.'
      ...
      activate('vityo-agent-command-loop', <String>[
        hasStyio
