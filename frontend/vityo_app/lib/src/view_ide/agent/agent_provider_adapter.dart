...
- If the IDE context includes agent.agentRegistry, read defaultAgentId, primaryAgentIds, subagentIds, hidden flags, maxSteps, and permissionRules before assigning primary or subagent work.
