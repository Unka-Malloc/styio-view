...
import 'package:vityo_app/src/ide/workspace/workspace_call_hierarchy.dart';
import 'package:vityo_app/src/ide/workspace/workspace_controller.dart';
import 'package:vityo_app/src/ide/workspace/workspace_code_lens.dart';
import 'package:vityo_app/src/ide/workspace/workspace_code_actions.dart';
import 'package:vityo_app/src/ide/workspace/workspace_declaration.dart';
import 'package:vityo_app/src/ide/workspace/workspace_definition.dart';
import 'package:vityo_app/src/ide/workspace/workspace_document_highlights.dart';
import 'package:vityo_app/src/ide/workspace/workspace_document_links.dart';
import 'package:vityo_app/src/ide/workspace/workspace_document_store.dart';
import 'package:vityo_app/src/ide/workspace/workspace_implementation.dart';
import 'package:vityo_app/src/ide/workspace/workspace_outline.dart';
import 'package:vityo_app/src/ide/workspace/workspace_problems.dart';
import 'package:vityo_app/src/ide/workspace/workspace_quick_open.dart';
import 'package:vityo_app/src/ide/workspace/workspace_reference_search.dart';
import 'package:vityo_app/src/ide/workspace/workspace_rename.dart';
import 'package:vityo_app/src/ide/workspace/workspace_search.dart';
import 'package:vityo_app/src/ide/workspace/workspace_symbol_search.dart';
import 'package:vityo_app/src/ide/workspace/workspace_type_definition.dart';
import 'package:vityo_app/src/ide/workspace/workspace_type_hierarchy.dart';
...
''',
    ...
    expect(
      await shell.openWorkspaceFile(result.links.single.resolvedFilePath!),
      isTrue,
    );
    ...
    expect(
      shell.debugLog.any(
        (entry) =>
            entry.contains('Workspace openFile opened lib/runtime.styio'),
      ),
      isTrue,
    );
  });
...
''',
    ...
    expect(await shell.openWorkspaceFile(typeDefinition.filePath), isTrue);
    shell.editorController.selectRange(
...
''',
    ...
    expect(await shell.openWorkspaceFile(implementation.filePath), isTrue);
    shell.editorController.selectRange(
