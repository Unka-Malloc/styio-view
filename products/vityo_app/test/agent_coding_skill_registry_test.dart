...
void main() {
  test('agent coding skill registry selects Styio skills first', () {
    ...
    expect(selection.skillIds, contains('vityo-agent-command-loop'));
    expect(selection.skillIds, contains('vityo-feature-loop'));
  ...
  test('agent coding skill registry selects Styio command loop skill', () {
    ...
    expect(selection.skillIds.first, 'vityo-agent-command-loop');
    expect(
