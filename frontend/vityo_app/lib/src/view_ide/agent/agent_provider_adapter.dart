...
- If the IDE context includes commands.lastResult, treat it as the latest user-confirmed IDE command outcome before deciding the next step. If commands.lastResult.commandId is collectProjectLanguageContext, read metadata.projectLanguage.suggestedCommandIds, metadata.projectLanguage.languageServiceStatus, metadata.projectLanguage.diagnosticCount, and metadata.projectLanguage.workspaceQuickFixes before choosing navigation, refresh, quick-fix, or semantic edit commands.
