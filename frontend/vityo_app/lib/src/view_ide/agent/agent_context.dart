...
class AgentContextSnapshot {
  ...
  final AgentCommandCatalogContext? commandCatalogContext;
  ...
  factory AgentContextSnapshot.fromJson(Map<String, Object?> json) {
    return AgentContextSnapshot(
      ...
      workspaceContext: json['workspaceContext'] != null
          ? AgentWorkspaceContext.fromJson(
              Map<String, Object?>.from(json['workspaceContext'] as Map))
          : null,
      documentContext: json['documentContext'] != null
          ? AgentDocumentContext.fromJson(
              Map<String, Object?>.from(json['documentContext'] as Map))
          : null,
      diagnosticsContext: json['diagnosticsContext'] != null
          ? AgentDiagnosticsContext.fromJson(
              Map<String, Object?>.from(json['diagnosticsContext'] as Map))
          : null,
      projectGraphContext: json['projectGraphContext'] != null
          ? AgentProjectGraphContext.fromJson(
              Map<String, Object?>.from(json['projectGraphContext'] as Map))
          : null,
      runtimeContext: json['runtimeContext'] != null
          ? AgentRuntimeContext.fromJson(
              Map<String, Object?>.from(json['runtimeContext'] as Map))
          : null,
      commandCatalogContext: json['commandCatalogContext'] != null
          ? AgentCommandCatalogContext.fromJson(
              Map<String, Object?>.from(json['commandCatalogContext'] as Map))
          : null,
      capabilityGapContext: json['capabilityGapContext'] != null
          ? AgentCapabilityGapContext.fromJson(
              Map<String, Object?>.from(json['capabilityGapContext'] as Map))
          : null,
      settingsSummary:
