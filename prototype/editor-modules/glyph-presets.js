...
export const operatorGlyphs = {
  ...
  "|<|": { tokenClass: "token-inline-return", visual: "↩" },
  "||>": { tokenClass: "token-task", visual: "⇉" },
  "?|": { tokenClass: "token-await", visual: "⧖" },
  ">>": { tokenClass: "token-iterator", visual: "↠" },
  "<<": { tokenClass: "token-copy", visual: "↞" },
  "?=": { tokenClass: "token-match", visual: "≟" },
  "??": { tokenClass: "token-diagnostic", visual: "⁇" },
  "|;": { tokenClass: "token-pipe-semi", visual: ";" },
