...
INDEX_META = {
    ...
    "docs/plan": ("Milestones Index", "Provide the generated inventory for `docs/plan/`; feature milestone rules live in [README.md](./README.md)."),
    "docs/plan": ("Plans Index", "Provide the generated inventory for `docs/plan/`; retired-plan boundaries and Better Plan workflow-state rules live in [README.md](./README.md)."),
