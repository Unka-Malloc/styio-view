...
| `ADAPTER-CONTRACTS-RUNBOOK.md` | `frontend/vityo_app/lib/src/backend_toolchain/`, legacy integration façade, `docs/contracts/`, `docs/external/for-styio/`, `docs/external/for-pafio/` |
