...
| `OBSERVABLE-DELIVERY-FOLLOW-UPS.md` | [Observable Delivery Follow-Ups](./OBSERVABLE-DELIVERY-FOLLOW-UPS.md) | Point Vityo agents at the unapproved observable-graph follow-ups, especially the execution-adapter envelope mismatch that drops real Pafio receipts. |
