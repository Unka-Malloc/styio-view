    ...
    if (method == 'initialize') {
      ...
      _success(id, <String, Object?>{
        ...
        'agentCapabilities': <String, Object?>{
          ...
          'styioExtensions': <String>['styio/test/write', 'styio/test/status'],
        },
        'authMethods': const <Object?>[],
        '_meta': <String, Object?>{
          'styio.test/privateEnvironmentVisible': Platform.environment
              .containsKey('STYIO_ACCEPTANCE_PRIVATE'),
        },
      });
      continue;
    }
...
void _handlePrompt(Object? id, Map<String, Object?> message) {
  ...
  if (text == 'capabilities') {
    _notification('styio/capabilities_changed', <String, Object?>{
      'capabilities': <String>['loadSession', 'styio/test/status'],
    });
