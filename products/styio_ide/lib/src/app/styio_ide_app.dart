...
class StyioIdeApp extends StatefulWidget {
  const StyioIdeApp({super.key, required this.bootstrap, this.initialPath});

  final AppBootstrap bootstrap;
  final String? initialPath;

  @override
  State<StyioIdeApp> createState() => _StyioIdeAppState();
}

class _StyioIdeAppState extends State<StyioIdeApp> {
