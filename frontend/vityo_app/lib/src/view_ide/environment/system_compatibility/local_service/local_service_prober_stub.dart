...
class UnsupportedLocalServiceProber implements LocalServiceProber {
  ...
  @override
  Future<LocalServiceFacts> probe() async => LocalServiceFacts(targetId: 'unsupported', operatingSystem: 'unknown', distributionId: 'unknown', architecture: 'unknown', providerKind: LocalServiceProviderKind.unsupported, supportsLoopbackHttpServer: false, supportsEphemeralPort: false, detectedAt: DateTime.now().toUtc());
}
