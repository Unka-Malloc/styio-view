...
class NotificationFacts {
  const NotificationFacts({
    ...
    required this.supportsDesktopNotifications,
    required this.supportsInAppFallback,
    this.detectedAt,
  });
  factory NotificationFacts.linuxDebianArm({
    String targetId = 'local',
    String architecture = 'aarch64',
    bool supportsDesktopNotifications = false,
    DateTime? detectedAt,
  }) => NotificationFacts(
    targetId: targetId,
