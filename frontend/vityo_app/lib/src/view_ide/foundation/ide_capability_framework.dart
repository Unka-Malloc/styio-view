    ...
    return const IdeCapabilityFrameworkSnapshot(
      ...
      entries: <IdeCapabilityDescriptor>[
        ...
        IdeCapabilityDescriptor(
          ...
          summary:
              'Testing surface is wired to runTests, native tool testResult records, TestRunProvider registry, TestDiscoveryProvider registry, test run configurations, persisted run configuration sets, test tree model, persisted test run history, runtime task lifecycle snapshots, persisted runtime task history, failed-test rerun planning, failed-test interaction, rerun-failed handoff, and CTest result parsing.',
          todo:
        ...
        IdeCapabilityDescriptor(
          ...
          ownerPath: 'lib/src/view_ide/commands',
          summary:
              'Command Palette surface is wired to StyioCommandRegistry, category contribution manifests, shell command execution, reusable query scoring, typed input draft contracts, keyboard shortcuts, persisted recent command ranking, and blocked command availability reasons.',
          todo:
              'TODO: promote this panel to an overlay palette with typed command input UI and richer command categories.',
          references: <String>[
        ...
        IdeCapabilityDescriptor(
          ...
          ownerPath: 'lib/src/view_ide/workspace',
          summary:
              'WorkspaceFileOperationService provides create, rename, delete, and reveal contracts backed by WorkspaceDocumentStore and WorkspaceController synchronization. WorkspaceFileExplorerController exposes a file tree snapshot, unified explorer actions, command palette file operation contributions, restored expanded/selected/revealed state, sort preferences, Foundation DataStore-backed explorer state persistence, and normalized File System Manager discovery results.',
          todo:
              'TODO: bind command palette file actions to concrete dialogs, richer file tree UI, and live File System Manager discovery/watch bindings.',
          references: <String>[
        ...
        IdeCapabilityDescriptor(
          ...
          summary:
              'ExecutionSession, runtime events, native tool results, runtime execution plans, dependency readiness checks, runtime execution handoff contracts, runtime task lifecycle snapshots, persisted runtime task history, and extension task contribution definitions expose stable serializable execution contracts for UI and Agent consumers.',
          todo:
              'TODO: bind RuntimeExecutionHandoff to concrete shell/toolchain execution managers, normalize hosted/toolchain-specific metadata fields, and attach task output streams.',
