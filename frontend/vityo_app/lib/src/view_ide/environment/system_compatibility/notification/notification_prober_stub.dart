...
class UnsupportedNotificationProber implements NotificationProber {
  ...
  @override
  Future<NotificationFacts> probe() async => NotificationFacts(targetId: 'unsupported', operatingSystem: 'unknown', distributionId: 'unknown', architecture: 'unknown', providerKind: NotificationProviderKind.unsupported, supportsDesktopNotifications: false, supportsInAppFallback: false, detectedAt: DateTime.now().toUtc());
}
