...
- If the IDE context includes agent.agentRegistry, read defaultAgentId, primaryAgentIds, subagentIds, hidden flags, maxSteps, and permissionRules before assigning primary or subagent work. If agent.toolCatalog is present, read each tool resultSchema and resultJsonSchema before interpreting tool outputs or retrying failed tool calls.
