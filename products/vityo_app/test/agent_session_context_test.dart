...
import 'package:vityo_app/src/view_ide/agent_client/agent_provider_registry.dart';
...
void main() {
  ...
  test('agent session context serializes editor and runtime facts', () {
    ...
    expect(
      ...
      VityoCommandRegistry.surfaceCommands.map((command) => command.id.name),
    );
    expect(
    ...
    expect(skillsJson['skillIds'], contains('vityo-feature-loop'));
    ...
    expect(skillsJson['skillIds'], contains('vityo-agent-command-loop'));
  ...
  test(
    ...
    () {
      ...
      expect(activeSkillIds, contains('vityo-agent-command-loop'));
      expect(activeSkillIds, contains('vityo-feature-loop'));
