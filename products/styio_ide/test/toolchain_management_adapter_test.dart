...
import 'package:styio_ide/src/view_ide/backend_toolchain/pafio_cli_support.dart';
...
''',
    ...
    final iosAdapter = await createToolchainManagementAdapter(
      platformTarget: PlatformTarget.ios,
    );
    final iosBlocked = await iosAdapter.installManagedCompiler(
      projectGraph: graph,
      styioBinaryPath: '/opt/styio/bin/styio',
    );
    expect(iosBlocked.status, ToolchainCommandStatus.blocked);
    expect(iosBlocked.statusMessage, contains('iOS'));
  });
