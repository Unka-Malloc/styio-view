...
import 'package:styio_ide/src/ide/agent_client/agent_session_recovery_store.dart';
import 'package:styio_ide/src/ide/workbench/agent_collaboration/collaboration_store.dart';
...
import 'package:styio_ide/src/presentation/agent_workbench/session_view.dart';
import 'package:styio_ide/src/presentation/agent_workbench/task_center.dart';
...
void main() {
  ...
  test('one failed Agent process does not invalidate a sibling', () async {
    final fixture = File(
      ...
      '${Platform.pathSeparator}styio_ide${Platform.pathSeparator}'
