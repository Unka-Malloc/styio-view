...
VIEW_RENDER_DIR = REPO_ROOT / "products" / "vityo_app" / "lib" / "src" / "view_render"
VIEW_IDE_DIR = REPO_ROOT / "products" / "vityo_app" / "lib" / "src" / "view_ide"
BACKEND_TOOLCHAIN_DIR = (
    REPO_ROOT / "products" / "vityo_app" / "lib" / "src" / "backend_toolchain"
)
INTEGRATION_DIR = REPO_ROOT / "products" / "vityo_app" / "lib" / "src" / "integration"
