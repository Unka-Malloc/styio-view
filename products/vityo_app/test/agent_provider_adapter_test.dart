...
import 'package:vityo_app/src/view_ide/agent_client/agent_provider_credential_resolver.dart';
import 'package:vityo_app/src/view_ide/agent_client/agent_provider_route_executor.dart';
import 'package:vityo_app/src/view_ide/agent_client/agent_tool_call_result_context.dart';
...
void main() {
  ...
  test('local-only adapter returns configuration fallback response', () async {
    ...
    expect(
      ...
      VityoCommandRegistry.surfaceCommands.length,
    );
  ...
  test(
    ...
    () async {
      ...
      expect(
        ...
        '/api/vityo-agent/v1/chat/completions',
      );
