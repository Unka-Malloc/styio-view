...
**Purpose:** Provide the inventory for `docs/`; directory boundaries and maintenance rules live in [README.md](./README.md).
...
| `design/` | [Design Index](./design/INDEX.md) | 定义 docs/design/ 作为产品、系统、已交付设计基线和缺口登记的 SSOT。 |
