    ...
    return const IdeCapabilityFrameworkSnapshot(
      ...
      entries: <IdeCapabilityDescriptor>[
        ...
        IdeCapabilityDescriptor(
          ...
          summary:
              'Styio-first parser, diagnostics, semantic facts, grammar-version facts, runtime status snapshots, capability health summaries, StyioServiceRuntimeOutputBinding language-service output events, extension language route consumption, and structured missing capability facts for provider binding.',
