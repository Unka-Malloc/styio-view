...
- If the IDE context includes commands.lastResult, treat it as the latest user-confirmed IDE command outcome before deciding the next step. If commands.lastResult.commandId is collectProjectLanguageContext, read metadata.projectLanguage.suggestedCommandIds and metadata.projectLanguage.languageServiceStatus before choosing navigation, refresh, or semantic edit commands.
